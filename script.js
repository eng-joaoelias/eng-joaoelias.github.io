...
const anoElemento = document.querySelector("#today-year");
const data = new Date();
...
function imprimeAnoAtual() {
  anoElemento.innerHTML = anoAtual;
}

window.addEventListener('scroll', mudaCorHeader);
window.addEventListener('DOMContentLoaded', imprimeAnoAtual);
